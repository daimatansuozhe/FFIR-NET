...
class LinearHeadwiseExpandConfig:
    ...
    # if num_heads=FFIR-NET, this is a normal linear layer
    # if num_heads>FFIR-NET, the in_features are split into num_heads and each head is projected separately
